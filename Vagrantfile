...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "wms-performance-testing"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    apt-get install -y xauth zip wget ifupdown unzip
    wget https://github.com/exoscale/cli/releases/download/v1.1.4/exoscale-cli_1.1.4_linux_amd64.deb
    DEBIAN_FRONTEND=noninteractive dpkg -i exoscale-cli_1.1.4_linux_amd64.deb
